...
export const skills: Skill[] = [
  ...
  { name: "Responsive UI & Design", description: "Mobile-first layouts with type, layout & systems in mind" },
  { name: "Payload", description: "Custom built CMS to meet your needs" },
